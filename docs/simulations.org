...
#+begin_src python :prologue "plt.clf()" :epilogue "plt.savefig(image, bbox_inches='tight'); print(image); del image" :results file :var image="msd.png"
import matplotlib.pyplot as plt
plt.plot(time, msd, '-o')
plt.xlabel("t")
plt.ylabel("MSD")
...
#+begin_src python :prologue "import matplotlib.pyplot as plt; plt.clf()" :epilogue "plt.savefig(image, bbox_inches='tight'); print(image); del image" :results file :var image="lammps.png"

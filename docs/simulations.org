...
Additional optimization algorithms (such as FIRE, l-BFGS, eigenvector-following, ...) are available in [[https://framagit.org/atooms/landscape][atooms-landscape]] component package.
